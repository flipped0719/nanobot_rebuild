...
class ConsoleChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        # 获取当前线程的事件循环对象，它不断地检查“哪些任务已经准备好继续执行”，并依次推进它们。
        ...
        while self._running:
            ...
            # _console.input()会等待用户输入，这是一个阻塞操作；用run_in_executor把阻塞输入移动到线程池
    ...
    async def send(
        ...
        # Markdown(content)把文本当成 Markdown 渲染
        _console.print()